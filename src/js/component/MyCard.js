...
export const MyCard = (props) => {
    ...
    const addFavorite = () => {
        ...
        if (props.type === "people") {
            newFavorite = store.people.find(item => item.name === props.name);
        } else if (props.type === "planets") {
            newFavorite = store.planets.find(item => item.name === props.name);
        } else if (props.type === "vehicles") {
            newFavorite = store.vehicles.find(item => item.name === props.name);
        } else {
